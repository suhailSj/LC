...
/**
 * created by suhail.jahangir on 28/10/20
 */
...
public class InsertBinaryTree {
    ...
    public static void main (String... a){
        ...
        TreeNode node = TreeHelper.initialize(new Integer[]{4,2,7,1,3});
        TreeHelper.printTree(solution.insertIntoBST(node, 5));
    ...
    static class Solution {
        ...
        private TreeNode process(TreeNode root, int val) {
            if(root == null){
                return new TreeNode(val);
            }
            if(root.val > val){
